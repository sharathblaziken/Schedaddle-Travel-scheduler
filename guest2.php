...
<td><width=40%></td>
<td><div class="hello"><input type="checkbox" name="preferences[]"  value="pub" size=10px onclick="uncheckGroup()" required/>pub</div></td>
</tr>
</div>
<tr>
<td></td>
...
<td><input id="noselect"  type="submit" value="Get Schedule"></td>
